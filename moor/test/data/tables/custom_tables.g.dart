...
class NoIdsCompanion extends UpdateCompanion<NoIdRow> {
  ...
  NoIdsCompanion setNoIdsCompanion(NoIdRow from) {
    return NoIdsCompanion(
      payload: Value(from.payload),
    );
  }

  factory NoIdsCompanion.fromRowClass(NoIdRow object,
      {bool nullToAbsent = false}) {
    return NoIdsCompanion();
  }
  static Map<String, Expression> fromRowClassToColumns(NoIdRow object,
      {bool nullToAbsent = false}) {
    return NoIdsCompanion.fromRowClass(object, nullToAbsent: nullToAbsent)
